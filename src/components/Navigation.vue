<template>
  <div id="nav" class="bg-gray-100 dark:bg-gray-900 border-blue-500 border-t-4 py-2">
    <div class="flex flex-row justify-between dynamic-padding items-center">
      <router-link to="/" tag="img" src="https://cdn.discordapp.com/attachments/886275305415790592/890882966371332106/logo.png" alt="C" class="h-8 crugg-logo cursor-pointer" />
